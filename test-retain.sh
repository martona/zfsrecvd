...
NAMES="stevedore-2026-07-27-1000Z
stevedore-2026-07-27-1030Z
stevedore-2026-07-27-1100Z
stevedore-2026-07-28-0900Z
stevedore-2026-07-28-0930Z
stevedore-2026-07-29-0900Z
stevedore-2026-07-29-1000Z
stevedore-2026-07-29-1005Z"

# hourly=2: hour-reps of 29-09 (0900) and 29-10 (1000) + frontier (1005)
r=$(run "hourly=2" "$NAMES")
exp="stevedore-2026-07-27-1000Z,stevedore-2026-07-27-1030Z,stevedore-2026-07-27-1100Z,stevedore-2026-07-28-0900Z,stevedore-2026-07-28-0930Z"
...
exp="stevedore-2026-07-27-1000Z,stevedore-2026-07-27-1030Z,stevedore-2026-07-27-1100Z,stevedore-2026-07-28-0930Z"
...
exp="stevedore-2026-07-27-1030Z,stevedore-2026-07-27-1100Z,stevedore-2026-07-28-0900Z,stevedore-2026-07-28-0930Z,stevedore-2026-07-29-0900Z,stevedore-2026-07-29-1000Z"
[[ "$r" == "$exp" ]] && ok "weekly/monthly reps are first-of-period" || bad "w1m1: $r"

# monthly=2 with a June straggler: both month-reps kept
r=$(run "monthly=2" "stevedore-2026-06-30-2359Z
$NAMES")
exp="stevedore-2026-07-27-1030Z,stevedore-2026-07-27-1100Z,stevedore-2026-07-28-0900Z,stevedore-2026-07-28-0930Z,stevedore-2026-07-29-0900Z,stevedore-2026-07-29-1000Z"
[[ "$r" == "$exp" ]] && ok "monthly=2 keeps both month reps" || bad "m2: $r"

# gaps don't burn budget: daily=3 over 3 sparse days keeps all reps
r=$(run "daily=3" "stevedore-2026-05-01-1200Z
stevedore-2026-06-15-1200Z
stevedore-2026-07-29-1200Z")
...
r=$(run "daily=1" "stevedore-2026-05-01-1200Z
stevedore-2026-06-15-1200Z
stevedore-2026-07-29-1200Z")
exp="stevedore-2026-05-01-1200Z,stevedore-2026-06-15-1200Z"
...
r=$(run "hourly=1 daily=1" "stevedore-2026-07-29-1005Z")
[[ -z "$r" ]] && ok "lone snapshot survives" || bad "lone: $r"

# out-of-order input: same result as sorted
r=$(run "hourly=2" "stevedore-2026-07-29-1005Z
stevedore-2026-07-27-1000Z
stevedore-2026-07-29-0900Z
stevedore-2026-07-28-0900Z
stevedore-2026-07-29-1000Z
stevedore-2026-07-27-1030Z
